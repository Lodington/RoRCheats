...
namespace RoRCheats
{
    internal class DrawMenu
    {
        ...
        public static void DrawStatsMenu(float x, float y, float widthSize, int mulY, GUIStyle BGstyle, GUIStyle buttonStyle)
        {
            ...
            GUI.Button(btn.BtnRect(1, false, "stats"), "Damage: " + Main.Localbody.damage, buttonStyle);
            GUI.Button(btn.BtnRect(2, false, "stats"), "Crit: " + Main.Localbody.crit, buttonStyle);
            GUI.Button(btn.BtnRect(3, false, "stats"), "Attack Speed: " + Main.Localbody.attackSpeed, buttonStyle);
            GUI.Button(btn.BtnRect(4, false, "stats"), "Armor: " + Main.Localbody.armor, buttonStyle);
            GUI.Button(btn.BtnRect(5, false, "stats"), "Regen: " + Main.Localbody.regen, buttonStyle);
            GUI.Button(btn.BtnRect(6, false, "stats"), "Move Speed: " + Main.Localbody.moveSpeed, buttonStyle);
            GUI.Button(btn.BtnRect(7, false, "stats"), "Jump Count: " + Main.Localbody.maxJumpCount, buttonStyle);
            GUI.Button(btn.BtnRect(8, false, "stats"), "Experience: " + Main.Localbody.experience, buttonStyle);
            GUI.Button(btn.BtnRect(9, false, "stats"), "Kills: " + Main.Localbody.killCount, buttonStyle);
        }
        ...
        public static void DrawPlayerModMenu(float x, float y, float widthSize, int mulY, GUIStyle BGstyle, GUIStyle buttonStyle, GUIStyle OnStyle, GUIStyle OffStyle, GUIStyle LabelStyle)
        {
            ...
            {
                PlayerModifiers.GiveLunarCoins();
            }
            if (GUI.Button(new Rect(x + widthSize - 80, y + Main.PlayerModBtnY, 40, 40), "-", OffStyle))
            {
            ...
            else if (!Main.ShowUnlockAll.Value)
            {
        ...
        public static void DrawItemManagementMenu(float x, float y, float widthSize, int mulY, GUIStyle BGstyle, GUIStyle buttonStyle, GUIStyle OnStyle, GUIStyle OffStyle, GUIStyle LabelStyle)
        {
            ...
            {
                itemManager.StackInventory(Main.LocalPlayerInv);
            }
            if (GUI.Button(btn.BtnRect(8, false, "itemmanager"), "Clear Inventory", buttonStyle))
            {
                itemManager.ClearInventory(Main.LocalPlayerInv);
            }
        }
